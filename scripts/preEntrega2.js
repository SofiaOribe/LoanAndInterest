...
const pedirPrestamo = () => {
    ...
    if(contPrestamo == "S" || contPrestamo == "s"){
            ...
            if(saldo > 0 && plazo > 0){
                ...
                alert("Ingreso datos inválidos, intentelo nuevamente.");
                return menuOpciones();
            }
...
const continuar = (opcion) => {
    if(opcion == "s" || opcion == "S"){//Si la opcion es Si
        ...
        opcion = "3";//Sino termina el ciclo
     }
}
...
const menuOpciones = () => {
    ...
    switch(menuOp){//Se abre la opcion indicada en la primer variable
        case "1": //Opcion 1: calcula prestamos
            ...
            //Paso las variables a la función para calcular interés
        ...
        case "2": //Opción 2: se abre el simulador de préstamos
            pedirPrestamo();
        break;
        default:
